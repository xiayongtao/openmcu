...
window.l_filtermode = [
    "Режим фильтрации изображения при изменении размера кадров: САМЫЙ БЫСТРЫЙ.", "Режим фильтрации изображения при изменении размера кадров: ОПТИМАЛЬНЫЙ (билинейная интерполяция).", "Режим фильтрации изображения при изменении размера кадров: САМЫЙ КАЧЕСТВЕННЫЙ."
];
...
window.l_server_id = "Идентификатор сервера HPKMCU";
