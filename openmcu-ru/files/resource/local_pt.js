...
<p>\
O serviço HPKMCU está a funcionar e a aceitar conexões.\
</p>\
<p>\
Conferência iniciada a partir de algum terminal irá funcionar no modo não controlado. Todos os participantes irão receber a mesma imagem. No modo não controlado, HPKMCU trocará o layout automaticamente a depender do número de participantes na conferência na ordem determinada no ficheiro "layouts.conf". Depois de atingir 100 participantes os próximos não serão vistos mas verão os outros.<br />\
