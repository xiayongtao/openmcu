...
<p>\
Le service HPKMCU est lancé et accepte les connexions\
</p>\
<p>\
Une conférence initiée par un terminal fonctionnera en mode non managé. Tous les membres verront la même image. En mode non managé HPKMCU change automatiquement la disposition en fonction du nombre de membres dans la conférence, dans l\'ordre défini dans le fichier "layouts.conf". Seuls les 100 premiers membres d\'une conférence seront visibles.<br/>\
